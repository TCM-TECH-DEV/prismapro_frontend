    ...
    <div class="container">
            ...
            <div class="col-lg-4">
                <div class="footer-info">
                    ...
                    <img src="{{ URL::asset('build/images/logo-dark.png') }}" alt="" height="28"
                        class="logo-dark">
                    <p class="footer-desc mt-4 mb-2 me-3">Toner provides best fashion experience for both men and women
                        at best pricing. We follow New fashion approach to give best premium feel.</p>
        ...
        <div class="row footer-border-alt mt-4 align-items-center fs-15">
            <div class="col-sm-6">
                ...
                {{-- Toner. Design &amp; Develop by <a href="https://themesbrand.com/" target="_blank" class="text-reset text-decoration-underline">Themesbrand</a> --}}
            </div>
            {{-- <div class="col-sm-6">
