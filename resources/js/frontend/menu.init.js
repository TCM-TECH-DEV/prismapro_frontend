...
function windowResizeHover() {
    var isElement = document.querySelectorAll(
        ".ecommerce-navbar .navbar-nav li"
    );
            ...
            if (a) {
                ...
                if (parentCollapseDiv) {
                    ...
                    if (parentCollapseDiv.parentElement) {
                        ...
                        if (
                            parentCollapseDiv.parentElement.parentElement
                                .parentElement
                        ) {
        ...
        document
            ...
            .forEach(function (elem) {
                if (
                    ...
                    elem.querySelector(".dropdown-menu").classList.remove(
                        "show"
                    );
                }
                if (elem.querySelector(".dropdown-toggle")) {
                    elem.querySelector(".dropdown-toggle").setAttribute(
                        "aria-expanded",
                        "false"
                    );
                }
